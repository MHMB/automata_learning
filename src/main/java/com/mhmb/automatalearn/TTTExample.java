...
public final class TTTExample {
    ...
    public static void main(String[] args) throws IOException{
        ...
        TTTLearnerDFA<Character> ttt = new TTTLearnerDFABuilder<Character>().withAlphabet(inputs)
                                                                            .withOracle(mqOracle)
                                                                            .create();
        ...
        // active learning
        DFAExperiment<Character> experiment = new DFAExperiment<>(ttt, wpMethod, inputs);
